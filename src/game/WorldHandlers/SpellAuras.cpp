...
void Aura::HandleModDetectRange(bool apply, bool Real)
{
    switch (GetId())
    {
        ...
        case 2908:
        {
            if (apply)
            {
                Aura* A = CreateAura(GetSpellProto(), EFFECT_INDEX_1, nullptr, m_spellAuraHolder, GetTarget(), GetCaster());
    ...
    if (apply)
    {
        switch (GetId())
        {
            ...
            case 8179:                                     // Grounding Totem
                target->CastSpell(target, 8178, true, nullptr, this);
                return;
            case 6474:                                     // Earthbind Totem
                target->CastSpell(target, 3600, true, nullptr, this);
                return;
            default:
                break;
        }
